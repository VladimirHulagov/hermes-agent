...
class TestClassifyApiError:
    ...
    def test_429_weekly_limit_exhausted(self):
        """429 with 'Weekly/Monthly Limit Exhausted' is billing (periodic quota
        exhaustion), not a transient rate limit.  Should trigger credential
        rotation, not retry backoff."""
        e = MockAPIError(
